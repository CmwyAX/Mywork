...
imfo & imfo::operator=(const imfo & copied)
{
	strcpy_s(departure, copied.departure);
	strcpy_s(arrival, copied.arrival);
	price = copied.price;
	departure_time = copied.departure_time;
	arrival_time = copied.arrival_time;
